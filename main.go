...
type (
	...
	// transformedTodo represents a formattee todo
...
func init() {
	...
	var err error
	db, err = gorm.Open("mysql", `root:12345@/demo?
...
// fetchSigleTodo fetch a single todo
...
func main() {
	...
	router := gin.Default() // similar to app = express();
